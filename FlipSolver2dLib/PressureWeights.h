#ifndef PRESSUREWEIGHTS_H
#define PRESSUREWEIGHTS_H
...
class PressureWeights : public MatrixWeights<PressureWeightsUnit>
{
public:
    PressureWeights(size_t size, LinearIndexable2d& indexer, double scale) :
