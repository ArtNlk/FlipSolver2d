...
public:
    ...
    typedef Eigen::SparseMatrix<Scalar,Eigen::ColMajor,StorageIndex> FactorType;
    typedef Eigen::Matrix<Scalar,Eigen::Dynamic,1> VectorSx;
    typedef Eigen::Matrix<RealScalar,Eigen::Dynamic,1> VectorRx;
    typedef Eigen::Matrix<StorageIndex,Eigen::Dynamic, 1> VectorIx;
...
public:
    ...
    void factorize(const Eigen::SparseMatrix<double,Eigen::Upper>& mat)
    {
